          ...
          <div className='col-12 col-md-4'></div>
            <div className='col-12 col-md-4 box py-5 border rounded mt-5 text-center'>
              ...
              <Link to={'/resume-generator'}>
                ...
                varient = 'contained'>Make your Resume</Button> 
              </Link>-
            </div>
            <div className='col-12 col-md-4'></div>
        </div>
      ...
      <section className='p-5'>
        ...
        <div className='row'>
          ...
          <div className='col-12 col-md-6'>
            <img src="https://cdn-images.zety.com/images/zety/landings/builder/in/resume-builder-template@3x.png" width={'400px'} alt="" />
          </div>
        </div>
      </section>
      ...
      <section id='bg2'>
        <div className="row p-5">
          ...
          <div className="col-12 col-md-6">
            <div className="row">
              <div className="col-3">
                <img src="https://www.resufit.com/wp-content/uploads/2025/04/article-image-47b3bcdb-bc5c-4a17-8671-cfff14fca563.webp" width={'200px'} alt="" />
              </div>
              <div className="col-3">
                <img src="https://www.resufit.com/wp-content/uploads/2025/04/article-image-47b3bcdb-bc5c-4a17-8671-cfff14fca563.webp" width={'200px'} alt="" />
              </div>
